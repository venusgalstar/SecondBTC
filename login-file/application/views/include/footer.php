      ...
      <div class="col-12 col-lg-3">
        <div class="footer-contact-list">
          <ul class="nav mt-5">
            ...
            <li>
            <li class="font-size-15 text-white nav-item mt-2">©<?php echo siteSetting()["site_name"]; ?> <?php echo lang('hak'); ?>
            <li>
          </ul>
        </div>
      </div>
...
<script type="text/javascript" charset="utf8" src="<?php echo base_url(); ?>assets/home/js/web3-modal.js"></script>
