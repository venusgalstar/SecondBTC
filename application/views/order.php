...
<div class="container-fluid">
    ...
    <div class="row" id="myTabContent">
        <div class="col-12 table-responsive">
            <table class="table table-hover table-responsive table-sm display" id="order-page1">
                <thead>
                    <tr>
    ...
    <div class="row" id="myTabContent">
        <div class="col-12 table-responsive">
            <table class="table table-responsive table-hover table-sm display" id="order-page2">
                <thead>
                    <tr>
                        <th class="text-right" scope="col"><?php echo lang("market"); ?></th>
                        <th class="text-center" scope="col"><?php echo lang("type"); ?></th>
