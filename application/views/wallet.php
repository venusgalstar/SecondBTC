    ...
    <div class="sub-header d-flex justify-content-between">
        <div class="market-pairs">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item"><a class="nav-link active" data-toggle="pill" href="#tab1" role="tab"><?= lang("wallet"); ?></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#tab2" role="tab"><?= lang('pendeposit'); ?></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#tab3" role="tab"><?= lang('deposithis'); ?></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#tab4" role="tab"><?= lang('penwithdraw'); ?></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#tab5" role="tab"><?= lang('withdrawhis'); ?></a></li>
            </ul>
        </div>
        <div>
            <!-- <form>
    ...
    <div class="clearfix">
        <div class="tab-content">
            <div class="tab-pane fade show active" id="tab1">
                <table class="table table-dark table-hover table-responsive table-sm display" id="wallet-page">
                    <thead>
                        <tr>
            ...
            <div class="tab-pane fade show" id="tab2">
                <table class="table table-hover table-responsive table-sm header-fixed" id="pendingDepositTable">
                    <thead>
                        <tr>
            ...
            <div class="tab-pane fade show" id="tab3">
                <table class="table table-dark table-responsive table-hover table-sm display header-fixed" id="depositHistoryTable">
                    <thead>
                        <tr>
            ...
            <div class="tab-pane fade show" id="tab4">
                <table class="table table-dark table-responsive table-hover table-sm display header-fixed" id="pendingWithdrawTable">
                    <thead>
                        <tr>
            ...
            <div class="tab-pane fade show" id="tab5">
                <table class="table table-dark table-responsive table-hover table-sm display header-fixed" id="WithdrawHistoryTable">
                    <thead>
                        <tr>
