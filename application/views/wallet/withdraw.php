    ...
    <div class="row mt-5">
        ...
        <div class="col-12">
            <div class="col-md-8 offset-md-2 col-sm-12 col-lg-6 offset-lg-3">
                <h3 class="font-size-15 ml-3 h5"> <?php echo lang("warning17"); ?> <b><?php echo lang("warning18"); ?></b></h3>
            </div>
            <div class="col-md-8 offset-md-2 col-sm-12 col-lg-6 offset-lg-3">
                <form>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="my-feedback text-muted small">Min. <?php echo lang("withdraw"); ?> : <?php echo Number($walletDetail[0]["wallet_min_with"], 8); ?> Max. <?php echo lang("withdraw"); ?> : <?php echo Number($walletDetail[0]["wallet_max_with"], 4); ?></div>
                    </div>
                    ...
                    <div class="col-12 text-right">
                        ...
                        <button class="btn btn-primary mb-5 btn-buy" onclick="customJS.wallet.userWithdrawMetamask()" type="button"><?php echo lang("withdraw"); ?></button>
