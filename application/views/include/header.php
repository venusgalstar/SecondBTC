...
<head>
    ...
    <meta name="description" content="Buy/Sell <?php echo $toWallet{
                                                    0}['wallet_name']; ?> with Cash or Credit Card |Zero Fee Cryptocurrency Exchange,Easily buy and sale <?php echo $toWallet{
                                                                                                                                                                0}['wallet_name']; ?> on BITMAA cryptocurrency Exchange" />
    ...
    ?>
        <link id="theme" rel="stylesheet" href="<?= base_url('assets/home'); ?>/css/dark-theme.css?v=<?= time(); ?>">
    <?php
    }
    ?>
    <link rel="stylesheet" href="<?= base_url('assets/home'); ?>/css/toast.css" defer />
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <a class="navbar-brand" href="<?= site_url(); ?>">
            <img id="navbar-logo" src="<?= base_url('assets/home') ?>/img/logo-light.svg" height="40" alt="BITMAA logo" loading="lazy">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-between align-items-center w-100" id="navbarNav">
            ...
            <ul class="navbar-nav">
                <li class="nav-item mr-4">
                    <a class="nav-link" href="<?= site_url('market'); ?>"><?php echo lang("market") ?></a>
                </li>
                <li class="nav-item mr-4">
                    <a class="nav-link" href="<?= site_url('wallet'); ?>"><?php echo lang("wallet") ?></a>
                </li>
                <li class="nav-item mr-4">
                ...
                <?php if (empty($_SESSION['user_data'][0]['user_email'])) { ?>
                    ...
                    <li class="nav-item mr-4">
                        <a class="btn btn-outline-primary cursor-pointer" onclick="customJS.auth.connect('<?= base_url() ?>')" href="#">Connect Wallet</a>
                ...
                <li class="nav-item dropdown mr-4">
                    ...
                    <div class="dropdown-menu dropdown-menu-right border-0 bg-dark" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item text-light font-size-12" href="<?php echo base_url(); ?>home/dilsec/ru/<?php echo $this->uri->uri_string() ?>" title="Pусский">Pуссий</a>
                        <a class="dropdown-item text-light font-size-12" href="<?php echo base_url(); ?>home/dilsec/es/<?php echo $this->uri->uri_string() ?>" title="Español">Espaol</a>
