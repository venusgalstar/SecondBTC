...
$config['mongo_db']['default']['username'] = 'bitmaa_db_user';
$config['mongo_db']['default']['password'] ='874aa8795tWmsadcsdfQz852XZaweBHTDExca';
$config['mongo_db']['default']['database'] = 'bitmaa_mongo_database';
