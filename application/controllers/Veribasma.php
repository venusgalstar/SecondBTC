...
public function pancaketest()
{
  $veri = vericek("https://api.pancakeswap.info/api/v2/tokens/0x5bcd91C734d665Fe426A5D7156f2aD7d37b76e30");
			$data = json_decode($veri,true);
      echo $data["data"]["price_BNB"];
      echo "<br>";
      $rand1 = "1.".rand(0,8).rand(3,97);
      $rand2 = "0.".rand(10,97);
      echo $rand1;
      echo "<br>";
      echo $data["data"]["price"]*$rand1;
      echo "<br>";
      echo $data["data"]["price"]*$rand2;
      $wallet = walletHelper("VIDT");
      //echo $wallet["wallet_cont"];
      //echo rand(1,15).".".rand(100,999);
       //var_dump( $data);
}
