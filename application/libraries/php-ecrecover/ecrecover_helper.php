...
require_once(APPPATH . 'libraries/php-ecrecover/CryptoCurrencyPHP/PointMathGMP.class.php');
require_once(APPPATH . 'libraries/php-ecrecover/CryptoCurrencyPHP/SECp256k1.class.php');
require_once(APPPATH . 'libraries/php-ecrecover/CryptoCurrencyPHP/Signature.class.php');

require_once(APPPATH . 'libraries/php-ecrecover/vendor/autoload.php');
// equire_once(APPPATH . 'libraries/php-ecrecover/vendor/kornrunner/keccak/src/Keccak.php');
...
function ecRecover($hex, $signed)
{
    ...
    echo "publicKeyString: $publicKeyString -> ";
    echo hex2bin($publicKeyString);
...
function verifySignature($message, $signature, $address)
{
    ...
    $ec = new EC('secp256k1');
    // echo "message: $message, msglen: $msglen, sign: $sign, recid: $recid, signature: $signature, hash: $hash\n";
