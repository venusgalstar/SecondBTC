...
<head>
    ...
    <style>
        ...
        .content span.code { display: block;font-weight: 400;margin-top: 20px;font-size: 18px;margin-bottom: 10px;text-align : left;}
...
<body>
   <div class="container">
       <div class="center">
           ...
           <div class="content">
               <span class="welcomer">
                   '.lang("hello").',<span class="name"></span>
               </span>
               <p>
                   <span class="name"> '.lang("warning13").'</span>
                   <span class="code"> '.lang("confcode").' : '.$code.' </span>
                   <div class="text"> '.lang("ipaddress").' : '.$IP.'</div>
                   <div class="text"> '.lang("date").' : '.$date.'</div>
               </p>
               <div class="support">
                   <span class="text">'.lang("warning14").'</span>
                   <a href="'.siteSetting()["site_url"].'/support" class="contant">'.siteSetting()["site_url"].'/support</a>
               </div>
               <span class="copyright">©'.date('Y').' '.siteSetting()["site_url"].', '.lang("hak").'</span>
           </div>
       </div>
   </div>
</body>
