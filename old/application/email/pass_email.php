   ...
   <div class="container">
       <div class="center">
           ...
           <div class="content">
               ...
               <p>
                   <span class="name"> '.lang("warning15").'</span>
                   <span class="code"> '.lang("passchange").' Link :<a href="'.base_url().'account/password?token='.$code.'"> '.base_url().'account/password?token='.$code.' </a></span>
