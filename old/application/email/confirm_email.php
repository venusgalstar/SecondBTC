   ...
   <div class="container">
       <div class="center">
           ...
           <div class="content">
               ...
               <p>
                   <span class="name"> '.lang("warning16").'</span>
                   <span class="code"> '.lang("email").' '.lang("confirm").' link :<a href="'.base_url().'account/emailonay?token='.$code.'"> '.base_url().'account/emailonay?token'.$code.' </a></span>
