                ...
                <ul class="navbar-nav">
                    <?php if (empty($_SESSION['user_data'][0]['user_email'])) { ?>
                        <li class="nav-item active text-right">
                            <a class="nav-link cursor-pointer" onclick="customJS.auth.loginWithMetamask('<?= base_url() ?>')" title="Login"><i class="fas fa-sign-in-alt"></i> <?php echo lang("login") ?></a>
                        </li>
                    ...
                    <li class="nav-item dropdown text-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right text-right border-0 bg-dark" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item text-light font-size-12" href="<?php echo base_url(); ?>home/dilsec/tr/<?php echo $this->uri->uri_string() ?>" title="TÃ¼rkÃ§e">TÃ¼rkÃ§e</a>
                            ...
                            <a class="dropdown-item text-light font-size-12" href="<?php echo base_url(); ?>home/dilsec/ru/<?php echo $this->uri->uri_string() ?>" title="PÑƒÑÑÐºÐ¸Ð¹">PÑƒÑÑÐºÐ¸Ð¹</a>
                            <a class="dropdown-item text-light font-size-12" href="<?php echo base_url(); ?>home/dilsec/es/<?php echo $this->uri->uri_string() ?>" title="EspaÃ±ol">EspaÃ±ol</a>
