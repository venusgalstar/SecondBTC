        ...
        <div class="tab-pane fade show active" id="tab1">
            <form class="" autocomplete="off">
                <div class="form-group">
                    ...
                    <label class="float-right mt-2" for="userFromBalance"><b id="userFromBalance" class="mr-1 cursor-auto">0.00000000</b><i id="fromWallet"><?php echo $fromWallet[0]['wallet_short']; ?></i>
                    </label>
                ...
                <div class="form-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text exchange-input"><?php echo $fromWallet[0]['wallet_short']; ?></div><input type="text" class="form-control form-control-sm text-right" id="buyFromPrice" oninput="customJS.exchange.tradeBuyPrice(this.value)" aria-describedby="textHelp" value="<?php echo Number($lastPrice, 8); ?>" data-toggle="tooltip" data-placement="right" title="<?php echo lang("price"); ?>" placeholder="0.00000000"><small id="buyFromPriceUyarı" class="form-text text-muted d-none">uyarı</small>
                    </div>
                    ...
                    <div class="input-group-prepend">
                        <div class="input-group-text exchange-input"><?php echo $fromWallet[0]['wallet_short']; ?></div><input type="text" class="form-control form-control-sm text-right" id="buyFromTotal" oninput="customJS.exchange.tradeBuyUnit(this.value)" aria-describedby="BuyTotal" data-toggle="tooltip" data-placement="right" title="<?php echo lang("total"); ?>" placeholder="0.00000000"><small id="buyFromTotalUyarı" class="form-text text-muted d-none">uyarı</small>
                    </div>
                </div>
                <?php
