    ...
    <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
        ...
        <form class="" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <label class="mt-2">
                    <h2 class="font-size-12 buyukharf"><?php echo lang("buy"); ?> <?php echo strtoupper($toWallet{
                                                                                    0}['wallet_name']); ?></h2>
                </label>

                <label class="float-right mt-2" for="userFromBalance"><b id="userFromBalance" class="mr-1 cursor-auto">0.00000000</b><i id="fromWallet"><?php echo $fromWallet{
                                                                                                                                                        0}['wallet_short']; ?></i></label>

                <div class="input-group-prepend">

                    <div class="input-group-text exchange-input"><?php echo $toWallet{
                                                                    0}['wallet_short']; ?></div>
            ...
            <div class="form-group">
                ...
                <div class="input-group-prepend">
                    ...
                    <div class="input-group-text exchange-input"><?php echo $fromWallet{
                                                                    0}['wallet_short']; ?></div>
            ...
            <?php if (!empty($_SESSION['user_data'][0]['user_email']) && !empty($_SESSION['user_data'][0]['user_id']) && $toWallet{
            0}['wallet_ex_status'] == 1) { ?>

                <button type="button" onclick="customJS.exchange.trade('buy')" id="buyButton" class="btn btn-success btn-block buyukharf"><?php echo lang("buy"); ?> <?php echo $toWallet{
                                                                                                                                                                    0}['wallet_short']; ?></button>

            <?php } elseif (!empty($_SESSION['user_data'][0]['user_email']) && !empty($_SESSION['user_data'][0]['user_id']) && $toWallet{
            0}['wallet_ex_status'] != 1) { ?>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
        ...
        <form class="" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <label class="mt-2">
                    <h2 class="font-size-12 buyukharf"><?php echo lang("sell"); ?> <?php echo strtoupper($toWallet{
                                                                                    0}['wallet_name']); ?></h2>
                </label>

                <label class="float-right mt-2" for="userToBalance"><b id="userToBalance" class="mr-1 cursor-auto">0.00000000</b><i id="toWallet"><?php echo $toWallet{
                                                                                                                                                    0}['wallet_short']; ?></i></label>
            ...
            0}['wallet_ex_status'] == 1) { ?>
                ...
                <button type="button" onclick="customJS.exchange.trade('sell')" id="sellButton" class="btn btn-danger btn-block buyukharf"><?php echo lang("sell"); ?> <?php echo $toWallet{
                                                                                                                                                                        0}['wallet_short']; ?></button>
