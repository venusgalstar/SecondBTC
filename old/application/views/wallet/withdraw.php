...
<div class="container">
  <div class="row mt-5">
    ...
    <div class="col-12">
      ...
      <div class="col-md-8 offset-md-2 col-sm-12 col-lg-6 offset-lg-3">
        <form>
          ...
          <div class="col-12 text-right">
            <label for="validationServer02" class="font-size-14 font-weight-bold"><?php echo lang("withdraw"); ?> <?php echo lang("fee"); ?>: <?php echo $walletDetail[0]["wallet_with_com"]; ?><?php $_GET["wallet"];?></label>
          </div>
          <div class="col-12 text-right">
      ...
      <input type="hidden" id="commission" value="<?php echo $walletDetail[0]["wallet_with_com"];?>">
    </div>
  </div>
</div>
