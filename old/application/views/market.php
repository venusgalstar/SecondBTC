        ...
        <div class="col-xl-12">
            <div class="row">
                <?php foreach ($marketUst as $marketUst) { 
                    if($marketUst["change"]<0){$renk="danger"; $arrow="down";}else{$renk="success"; $arrow="up";}?>
...
<div class="container">
    <div class="row mt-4">
       <!-- <div class="col-12 text-center font-size-15 text-secondary font-weight-bold"><i class="fas fa-bullhorn"></i> <?php echo $news{0}['news_title']; ?>: <?php echo kisaltKelime($news{0}['news_detail'],35); ?><span class="ml-3"><a href="<?php echo base_url();?>/news">|  <?php echo lang("detail");?></a></span></div>-->
    </div>
    <div class="row mt-5">
        ...
        <div class="col-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <?php foreach ($marketPair as $pairs) {
                    if($pairs['wallet_main_pairs']==1){$active = 'active';}else{$active = '';}
