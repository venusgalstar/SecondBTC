...
var toID = $("#toShort").val();
var fromID = $("#fromShort").val();
chart.dataSource.url = $("#url").html()+"api/public/orderBook?filter="+toID+"_"+fromID+"&limit=50";
