...
if (pagename == '') pagename = "market"; // Added by Kamal
    ...
    function myFunction(t) {
        ...
        e.on("marketveri", function (t) {
            ...
            $.each(t.data, function (t, e) {
                ...
                d += '<tr>' +
                    '<td class="text-left" scope="row">' + lbl + '</td>' +
                    '<td class="text-left" scope="row">' + e.to_wallet_name + '</td>' +
                    '<td class="text-right">' + e.to_wallet_last_price.toFixed(8) + '</td>' +
                    '<td class="text-right text-' + i + '">' + a + '%</td>' +
                    '<td class="text-right">' + o + '</td>' +
                    '<td class="text-right">' + r + '</td>' +
                    '<td class="text-right">' + l + '</td>' +
                    '<td class="text-right"><a class="btn btn-sm btn-buy" href="' + s + '">Trade</a></td>' +
                    '</tr>';
            }),
            $("#market").html(d);
