   ...
   <div class="container">
       <div class="center">
           ...
           <div class="content">
               ...
               <p>
                   <span class="name"> Your administrator password has been changed.</span>
                   <span class="code"> New Pass :'.$code.'</span>
                   <div class="text"> Date : '.$date.'</div>
               </p>
               <div class="support">
                   <span class="text">If you do not know anything, please contact the administrator.</span>
               </div>
